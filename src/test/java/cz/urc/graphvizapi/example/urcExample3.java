...
public class urcExample3 {
    ...
    {
        urcExample3 ex = new urcExample3 ();
        ex.draw0();
    }
    ...
    private void draw0()
    {
        ...
        String graphvizStr = GraphService.convertToGraphviz(containers);
   	
        
        System.out.println("graph:");
        System.out.println("=============================");
        System.out.println(graphvizStr);
        System.out.println("=============================");
    ...
    public byte[] getGraphByteArray(String dotSource, String type, String dpi)
    {
        File dot = null;
    ...
    private File writeDotSourceToFile(String str) throws java.io.IOException
    {
        File temp ;
        try {
            temp = File.createTempFile("graph_", ".dot.tmp", new File("/Users/mryska/prac/tmp"));
